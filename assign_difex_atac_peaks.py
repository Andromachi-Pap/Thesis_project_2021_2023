# -*- coding: utf-8 -*-
"""
Created on Fri Jul 29 15:05:52 2022

@author: User
"""
#SCRIPT THAT MAPS THE DIFFERENTIALLY EXPRESSED ELEMENTS ACROSS PEAKS AND GENOME (ATAC-SEQ, RNA-SEQ)

import os
import pandas as pd


#Load the differentially expressed peaks
#we used the ones we defined from deseq from nf-core run of atac-seq
path = os.chdir("C:/Users/User/Desktop/Msc_Bioinformatics_ 2020-2022/Master Thesis 2021-2022/DESeq_atac")
path
...
#Load the consensus peaks files 
